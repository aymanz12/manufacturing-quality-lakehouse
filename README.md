...
### **Project Overview**
Architected and developed a fully automated end-to-end data pipeline, orchestrated via **AWS Glue Workflows**, using PySpark to process millions of manufacturing inspection logs. Implementing a Medallion Lakehouse Architecture (Bronze, Silver, Gold), the platform transforms raw, messy factory floor data into a highly optimized Star Schema using the Delta Lake format. 
